...
public class ClustersTest {
  ...
  @Test
  public void testAvgRadius() {
    setUp1();
    assertEquals(cluster3.getAvgRadius(), 200110.9867, .01);
    tearDown();
  }
  ...
  public void testMeanRadiusClusters() {
    setUp1();
    assertEquals(cluster1.meanRadiusClusters(cluster2), 200110.9867, .01);
    tearDown();
  }
  ...
  @Test
  public void testMeanRadiusNode() {
    setUp1();
    assertEquals(cluster1.meanRadiusNode(node4), 166701.05, 0.01);
    tearDown();
  }
