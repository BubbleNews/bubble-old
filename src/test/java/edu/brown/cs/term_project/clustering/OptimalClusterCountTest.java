...
public class OptimalClusterCountTest {
  ...
  public void setUp1() {
    ...
    edges.add(new Edge(node2, node3, 1000001));
  ...
  @Test
  public void testFindClusterNodes() {
    setUp1();
    List<Node> nodeTest = new ArrayList<>();
    nodeTest.add(node2);
    nodeTest.add(node3);
    assertEquals(OptimalClusterCount.findClusterNodes(cluster3.getNodes(), edges, 2), nodeTest);
    tearDown();
  }
